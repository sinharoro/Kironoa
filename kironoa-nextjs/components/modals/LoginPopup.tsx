...
export default function LoginPopup({ onClose }: Props) {
  ...
  const handleLogin = async () => {
    ...
    // Auto-append @gmail.com if no domain given
    ...
    <>
      ...
      <div className="absolute top-14 right-0 z-50">
        <div className="glass-login">
          <div className="glass-login-inner" style={{ minWidth: 280 }}>
            <p style={{ textAlign: 'center', marginBottom: '1em', color: 'white', fontSize: '1.2em' }}>
              Login
            </p>
